        ...
        <div className="hero-content">
          <div className="hero-text">
            ...
            <div className="hero-socials" data-reveal>
              ...
              <a href="https://www.linkedin.com/in/diane-kumena-aaaa70342/" target="_blank" rel="noopener noreferrer" className="social-link" aria-label="LinkedIn">Li</a>
              <a href="https://web.facebook.com/profile.php?id=100085180773334" target="_blank" rel="noopener noreferrer" className="social-link" aria-label="Facebook">Fb</a>
            </div>
          </div>
